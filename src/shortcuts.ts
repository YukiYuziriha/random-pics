...
export const SHORTCUT_REGISTRY: ShortcutAction[] = [
  ...
  { id: 'next-folder', label: 'next-folder', leftKey: '5', rightKey: '7', showHint: true },
  { id: 'prev-folder', label: 'prev-folder', leftKey: '4', rightKey: '6', showHint: true },
  { id: 'reindex-folder', label: 'reindex-folder', leftKey: '3', rightKey: '8', showHint: true },
  { id: 'pick-folder', label: 'pick-folder', leftKey: '2', rightKey: '9', showHint: true },
...
const SHORTCUT_DISPLAY_ORDER: Record<ShortcutLayoutSection, Record<ShortcutSide, string[]>> = {
  ...
  'folder-controls': {
    left: ['pick-folder', 'reindex-folder', 'prev-folder', 'next-folder'],
    right: ['prev-folder', 'next-folder', 'reindex-folder', 'pick-folder'],
  },
};
